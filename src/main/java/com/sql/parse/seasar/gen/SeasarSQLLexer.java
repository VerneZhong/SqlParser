...
public class SeasarSQLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "T__15", "LT", "GT", 
			"IDENTIFIER", "NUMBER", "STRING", "WS", "COMMENT", "CONDITIONAL_COMMENT"
		};
	}
	...
	public SeasarSQLLexer(CharStream input) {
		super(input);
